...
},{"process":"brFV"}],"US5u":[function(require,module,exports) {
"use strict";
...
$tabBar.on("click", "li", function (e) {
  var $li = (0, _jquery.default)(e.currentTarget); //e.currentTarget字符串

  $li.addClass("selected").siblings().removeClass("selected");
  var index = $li.index(); //查看在父元素中排老几

  $tabContent.children().eq(index).addClass("active").siblings().removeClass("active"); //eq就是选择第几个
});
...
//# sourceMappingURL=main.c7a7ea0c.js.map